...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../Stylesheets/add_employee.css">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
	...
	<div class="container-fluid body_area body_content">
		<br>
		<img class="img-responsive heading_image" src="https://img.icons8.com/fluent/48/000000/add-user-male.png"/><span id="heading">Add Employee</span><br><br>
		<!-- Breadcrumb -->
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><span>Add Employee</span></li>
        </ol>
      </nav>
      <!-- /Breadcrumb -->
	  <br>
      ...
      <div class="row">
        <div class="col-sm-7 left_side">
          ...
          <tbody>
            <tr><td><label>Full Name:</label></td><td><input type="text" name="emp_name" class="form-control"></td></tr>
            ...
            <tr><td><label>Contact No 1:</label></td><td><input type="text" name="contact_no" class="form-control"></td></tr>
            <tr><td><label>Contact No 2:</label></td><td><input type="text" name="contact_no2" class="form-control"></td></tr>
            <input type="hidden" name="image_" class="image-tag">
          </tbody>
        </table></center>
        <button type="submit" class="btn btn-outline-success" style="float: right;margin-right: 10px;"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbspAdd Employee</button>
        </div>
        <div class="col-sm-5">
